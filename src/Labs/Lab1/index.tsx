	...
	return (
		<div id="wd-lab1">
		    ...
		    <div id="wd-lists">
				...
				My favorite recipe - Avgolemono Soup:
				<ol id="wd-my-favorite-recipe">
					<li>Shred cooked chicken.</li>
			        <li>Heat pot with some olive oil.</li>
			        <li>Add diced onions, celery, and carrots to the pot.</li>
			        <li>Once vegetables are soft, add broth.</li>
			        <li>After the broth reaches a boil, add chicken and pasta.</li>
			        <li>Let pasta cook.</li>
			        <li>Slowly add in lemon juice and season to taste.</li>
			        <li>Serve and enjoy!</li>
				</ol>
		    ...
		    <div id="wd-images">
		    	...
		    	<br />
		    		<img id="wd-teslabot" height="200px" src="images/teslabot.jpg" />
		    	<br />
		    </div>
		    <div id="wd-forms">
		    	<h4>Form Elements</h4>
		    	<form id="wd-text-fields">
			        ...
			        <a href="https://github.com/ana-bordeianu" id="wd-github"> My GitHub </a>
			        profile<br/>
		    	</form>
		    </div>
		</div>
